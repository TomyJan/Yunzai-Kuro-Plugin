...
- [ ] 追平最新请求头, 更进一步独有化请求头, 输出的信息对uid和昵称进行打码

- [ ] issue 模板优化, 添加 框架版本 输入, 尝试是否可以添加自动关闭无效 issue 的 action , 同步到 Yunzai-TomyJan-Plugin
...
有 bug? 要新功能? [提交 Issue](https://github.com/TomyJan/Yunzai-Kuro-Plugin/issues/new/choose)
